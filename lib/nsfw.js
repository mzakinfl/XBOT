 ...
 * @returns {Object}
 */
const xxxdl = (url) => new Promise((resolve, reject) => {
...
/**
 * Get XXX video from query.
 * @param {String} query
 * @returns {Object}
 */
const xxxsearch = (query) => new Promise((resolve, reject) => {
    console.log(`Get XXX video from ${query}`)
    fetchJson(`https://api.vhtear.com/xxxsearch?query=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
/**
...
const nekopoi = (query) => new Promise((resolve, reject) => {
    console.log(`Get Nekopoi Lastest Videos`)
    fetchJson(`https://api.vhtear.com/nekonewepisode&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
module.exports = {
