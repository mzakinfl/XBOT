    ...
    bocchi.onGlobalParicipantsChanged(async (event) => {
        ...
        try {
            if (event.action === 'add' && event.who !== botNumbers && isWelcome) {
                ...
                if (pic === undefined) {
                    var picx = 'https://i.pinimg.com/originals/fe/c1/25/fec1256548f2df11323d6462305bfdf2.jpg'
                } else {
                    picx = pic
                }
                const welcomer = await new canvas.Welcome()
                    ...
                    .setBackground('https://i.pinimg.com/originals/fe/c1/25/fec1256548f2df11323d6462305bfdf2.jpg')
                    .toAttachment()
                const base64 = `data:image/png;base64,${welcomer.toBuffer().toString('base64')}`
                await bocchi.sendFile(event.chat, base64, 'welcome.png', `Halo ${pushname} 👋 Selamat Datang ^_^`)
                ...
                await bocchi.sendFile(event.chat, base64, 'welcome.png', `Dadahh ${pushname}, Gua Doain Ke Tabrak Truk, Kelindas Kepala Nya Terus Pecah`)
            }
        } catch (err) {
            console.error(err)
        }
